                  ...
                  >
                    <div className="bg-white text-slate-900 border border-slate-200 rounded-2xl shadow-2xl p-5 pb-7 ">
                      ...
                      <div className="pb-3 border-b border-slate-100 mb-3">
                        ...
                        <p className="text-[10px] text-slate-400 font-mono">Assistant Professor(SR), Dept. of IT, IRTT</p>
                      </div>
          ...
          <main className="relative z-10 flex-grow w-full max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="flex flex-col items-start max-w-xl">
              <motion.div
                ...
                className="space-y-4"
              >
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-display font-bold italic text-white leading-tight tracking-tight">
                  Inspire. Educate.<br />
                  Empower.
                </h1>
